...
use @gtk_about_dialog_get_license[Pointer[U8]](gabout: GtkAboutDialog)
use @gtk_about_dialog_get_license_type[I32](gabout: GtkAboutDialog)
...
use @gtk_about_dialog_set_license[None](gabout: GtkAboutDialog, glicense: Pointer[U8] tag)
use @gtk_about_dialog_set_license_type[None](gabout: GtkAboutDialog, glicense_type: I32)
...
struct GtkAboutDialog
  ...
  fun ref get_license(): String =>
    var cstr: Pointer[U8] ref =    @gtk_about_dialog_get_license(this)
    let p: String iso = String.from_cstring(cstr).clone()
    consume p

  fun ref get_license_type(): I32 =>
  ...
  fun ref set_license(license: String): None =>
    @gtk_about_dialog_set_license(this, license.cstring())

  fun ref set_license_type(license_type: I32): None =>
    @gtk_about_dialog_set_license_type(this, license_type)
