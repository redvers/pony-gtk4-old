...
"""
  fun gtk_about_dialog_get_type(): U64 =>
"""

"""
    @gtk_about_dialog_get_type()
  fun gtk_about_dialog_new(): NullablePointer[SGtkWidget] =>
"""
Creates a new `GtkAboutDialog`.a newly created `GtkAboutDialog`
"""
    @gtk_about_dialog_new()
  fun gtk_about_dialog_get_program_name(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_program_name(about: NullablePointer[SGtkAboutDialog] tag, name: Pointer[U8] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_version(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
Returns the version string.The version stringa `GtkAboutDialog`
"""
    @gtk_about_dialog_get_version(about)
  fun gtk_about_dialog_set_version(about: NullablePointer[SGtkAboutDialog] tag, version: Pointer[U8] tag): None =>
"""
Sets the version string to display in the about dialog.a `GtkAboutDialog`the version string
"""
    @gtk_about_dialog_set_version(about, version)
  fun gtk_about_dialog_get_copyright(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
Returns the copyright string.The copyright stringa `GtkAboutDialog`
"""
    @gtk_about_dialog_get_copyright(about)
  fun gtk_about_dialog_set_copyright(about: NullablePointer[SGtkAboutDialog] tag, copyright: Pointer[U8] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_comments(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
Returns the comments string.The commentsa `GtkAboutDialog`
"""
    @gtk_about_dialog_get_comments(about)
  fun gtk_about_dialog_set_comments(about: NullablePointer[SGtkAboutDialog] tag, comments: Pointer[U8] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_license(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
Returns the license information.The license informationa `GtkAboutDialog`
"""
    @gtk_about_dialog_get_license(about)
  fun gtk_about_dialog_set_license(about: NullablePointer[SGtkAboutDialog] tag, license: Pointer[U8] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_license_type(about: NullablePointer[SGtkAboutDialog] tag, licensetype: I32): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_license_type(about: NullablePointer[SGtkAboutDialog] tag): I32 =>
"""
Retrieves the license type.a [enum@Gtk.License] valuea `GtkAboutDialog`
"""
    @gtk_about_dialog_get_license_type(about)
  fun gtk_about_dialog_get_wrap_license(about: NullablePointer[SGtkAboutDialog] tag): I32 =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_wrap_license(about: NullablePointer[SGtkAboutDialog] tag, wraplicense: I32): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_system_information(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_system_information(about: NullablePointer[SGtkAboutDialog] tag, systeminformation: Pointer[U8] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_website(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
Returns the website URL.The website URLa `GtkAboutDialog`
"""
    @gtk_about_dialog_get_website(about)
  fun gtk_about_dialog_set_website(about: NullablePointer[SGtkAboutDialog] tag, website: Pointer[U8] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_website_label(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_website_label(about: NullablePointer[SGtkAboutDialog] tag, websitelabel: Pointer[U8] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_authors(about: NullablePointer[SGtkAboutDialog] tag): NullablePointer[Pointer[U8]] =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_authors(about: NullablePointer[SGtkAboutDialog] tag, authors: NullablePointer[Pointer[U8]] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_documenters(about: NullablePointer[SGtkAboutDialog] tag): NullablePointer[Pointer[U8]] =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_documenters(about: NullablePointer[SGtkAboutDialog] tag, documenters: NullablePointer[Pointer[U8]] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_artists(about: NullablePointer[SGtkAboutDialog] tag): NullablePointer[Pointer[U8]] =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_artists(about: NullablePointer[SGtkAboutDialog] tag, artists: NullablePointer[Pointer[U8]] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_translator_credits(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_translator_credits(about: NullablePointer[SGtkAboutDialog] tag, translatorcredits: Pointer[U8] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_get_logo(about: NullablePointer[SGtkAboutDialog] tag): NullablePointer[GdkPaintable] =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_logo(about: NullablePointer[SGtkAboutDialog] tag, logo: NullablePointer[GdkPaintable] tag): None =>
"""
Sets the logo in the about dialog.a `GtkAboutDialog`a `GdkPaintable`
"""
    @gtk_about_dialog_set_logo(about, logo)
  fun gtk_about_dialog_get_logo_icon_name(about: NullablePointer[SGtkAboutDialog] tag): Pointer[U8] =>
"""
...
"""
  ...
  fun gtk_about_dialog_set_logo_icon_name(about: NullablePointer[SGtkAboutDialog] tag, iconname: Pointer[U8] tag): None =>
"""
...
"""
  ...
  fun gtk_about_dialog_add_credit_section(about: NullablePointer[SGtkAboutDialog] tag, sectionname: Pointer[U8] tag, people: NullablePointer[Pointer[U8]] tag): None =>
"""
