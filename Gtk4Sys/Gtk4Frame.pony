...
"""
    ...
    @printf("gnew(label: Pointer[U8] tag)\n".cstring())
    @gtk_frame_new(label)
...
"""
    ...
    @printf("set_child(frame: NullablePointer[SGtkFrame] tag, child: NullablePointer[SGtkWidget] tag)\n".cstring())
...
"""
    ...
    @printf("get_child(frame: NullablePointer[SGtkFrame] tag)\n".cstring())
