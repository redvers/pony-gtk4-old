...
"""
    ...
    @printf("gtk_drawing_area_set_content_width(self: NullablePointer[SGtkDrawingArea] tag, width: I32)\n".cstring())
...
"""
    ...
    @printf("gtk_drawing_area_get_content_width(self: NullablePointer[SGtkDrawingArea] tag)\n".cstring())
...
"""
    ...
    @printf("gtk_drawing_area_set_content_height(self: NullablePointer[SGtkDrawingArea] tag, height: I32)\n".cstring())
...
"""
    ...
    @printf("gtk_drawing_area_get_content_height(self: NullablePointer[SGtkDrawingArea] tag)\n".cstring())
