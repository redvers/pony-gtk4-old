...
"""
    ...
    @printf("gtk_window_get_application(window: NullablePointer[SGtkWindow] tag)\n".cstring())
...
"""
    ...
    @printf("gtk_window_set_application(window: NullablePointer[SGtkWindow] tag, application: NullablePointer[SGtkApplication] tag)\n".cstring())
...
"""
    ...
    @printf("gtk_window_set_child(window: NullablePointer[SGtkWindow] tag, child: NullablePointer[SGtkWidget] tag)\n".cstring())
